...
public class Emaildataadminsion extends HttpServlet {
    public void sendEmail(String emailreceiver) {
        ...
        try {
            ...
            message.setSubject("Admission Message");
            message.setText("Your application form has been received, thank you!!");
